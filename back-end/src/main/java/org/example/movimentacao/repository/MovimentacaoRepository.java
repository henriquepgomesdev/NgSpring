...
public interface MovimentacaoRepository extends JpaRepository<Movimentacao, Long> {
    ...
    @Query("""
                SELECT new org.example.movimentacao.model.SaldoAtivoOutput(
                    MIN(m.data),
                    MAX(m.data),
                    m.configuracaoAtivo.nome,
                    m.configuracaoAtivo.id,
                    m.movimentacaoOrigem.id,
                    ...
                    m.movimentacaoOrigem.valorAplicado as valorInicial,
                ...
                GROUP BY m.configuracaoAtivo.nome, m.configuracaoAtivo.id, m.movimentacaoOrigem.id, m.movimentacaoOrigem.valorAplicado, m.configuracaoAtivo.quantidadeDias
                ORDER BY m.configuracaoAtivo.nome
            """)
    List<SaldoAtivoOutput> calcularSaldoPorConfiguracaoAtivo(LocalDate dataInicial, LocalDate dataFinal);
